...
class User {
  ...
  static async signup(firstName, lastName, email, password) {
    try {
      const response = await axios.post('https://act-production-5e24.up.railway.app/api/auth/register', {
        firstName,
        lastName,
        email,
        password,
  ...
  static async login(email, password) {
    try {
      const response = await axios.post('https://act-production-5e24.up.railway.app/api/auth/login', {
        email,
        password,
      });
      return response.data;
